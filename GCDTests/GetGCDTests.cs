...
namespace GCDTests
{
    ...
    public class GetGCDTests
    {
        ...
        public int GCDEuklidTests_WithFourArguments_ExpectedGDCValue(int a, int b, int c, params int[] d)
        {
            return GetGCD.GCDEuklid(a, b, c, d);
        }
        ...
        {
            Assert.That(() => GetGCD.GCDStein(14, 120, 8, null), Throws.ArgumentNullException);
        }
